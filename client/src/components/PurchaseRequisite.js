...
function PurchaseRequisite({ onNavigate }) {
  ...
  const detailFields = (pr) => [
    ...
    { label: 'Source', value: pr.source === 'replenish_report' ? 'Replenish Report' : 'Manual' },
      ...
      <div className="pr-user-bar">
        <label>
          ...
          <input
            ...
            value={currentUser}
            onChange={(e) => {
              setCurrentUserState(e.target.value);
              setCurrentUser(e.target.value);
            }}
            placeholder="Enter your name for new PRs from Replenish Report"
          />
        </label>
        <span className="pr-user-hint">
          This name is saved locally and used automatically when you create PRs from the Replenish
          Report.
        </span>
      </div>
        ...
        <div className="pr-table-container">
          <table className="pr-table">
            ...
            <tbody>
              {requisites.length === 0 ? (
                <tr>
                  <td colSpan="10" className="pr-no-data">
                ...
                requisites.map((pr) => {
                  ...
                  >
                    ...
                    <td>{pr.source === 'replenish_report' ? 'Replenish Report' : 'Manual'}</td>
